...
<div class="mainbody">
    ...
    <div class="col-9 bg-white  content pt-2 ps-2 me-2">
        <div class="d-flex">
           <div class="part1 me-2">
                <h4 class="text-primary"> Đăng ký</h4>
                <div class="spacing mt-3 me-3">
                </div>
                <form class="mt-3" action="register_check.php" method="POST" >
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="form-check-label" name="user_name" class="form-control" id="exampleInputPassword1">
  </div>
  <div class="mb-3">
  ...
  <button name="gui" type="submit" class="btn btn-primary">Submit</button>
